package com.heqing.redisson.config;

import com.heqing.redisson.msg.PatternTopicDemo;
import com.heqing.redisson.msg.TopicDemo;
...
@Configuration
@EnableAsync
@ComponentScan("com.heqing.redisson.*")
